...
public class Main {
    public static void main(String[] args) {
        ...
        TreeSet<Conclusion> result = merge(person,auth);
    ...
    public static TreeSet<Conclusion> merge(TreeSet<Person> persons, TreeSet<Auth> auths){
        TreeSet<Conclusion> list = new TreeSet<>();
